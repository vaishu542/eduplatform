        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-300 p-4">
            <div className="bg-[#F5F5F5] p-4 sm:p-6 rounded-md shadow-md w-full text-ash max-w-md transform transition-all duration-300">
                ...
                <input
                    ...
                    className="border rounded-md px-2 sm:px-3 py-1.5 sm:py-2 w-full mb-3 sm:mb-4 text-sm sm:text-base"
                />
                <input
                    type="email"
                    name="email"
                ...
                <textarea
                    ...
                    rows={3}
                />
                <Button text={"ENROLL"} onClick={handleEnroll} className={"w-full rounded-3xl font-bold py-2 sm:py-3 text-sm sm:text-base"} />
            </div>
        </div>
    );
};
